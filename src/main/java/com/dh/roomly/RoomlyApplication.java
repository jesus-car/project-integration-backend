	...
	CommandLineRunner commandLineRunner() {
		return args -> {
			...
			RoleEntity clientRoleEntity = RoleEntity.builder()
					...
					.description("Cliente")
					.grant(Set.of(readPermission, updatePermission, deletePermission, writePermission))
					.build();

			RoleEntity sellerRoleEntity = RoleEntity.builder()
					.name(RoleEnum.ROLE_OWNER)
					.description("Propietario")
					.grant(Set.of(readPermission, writePermission, deletePermission, updatePermission))
					.build();
